      ...
      <div>
        ...
        >
          ...
          >
            ...
            />
            <div
              className={`absolute w-max  "left-1/2 -translate-x-1/2 top-12" : "-top-12 left-0"} opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none `}
            >
        ...
        >
          ...
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              ...
              <p>Scan to get DeepSeek Ai app</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
